...
namespace InvoiceGenerator.Utility.NumberToWord
{
    public static class NumberToWordConvertor
    {
        public static string NumberToWords(double doubleNumber)
        {
            ...
            string beforeFloatingPointWord = string.Format("{0} Dirhams ", NumberToWords(beforeFloatingPoint));
            string afterFloatingPointWord = string.Format("{0} Fils only.", SmallNumberToWord((int)(Math.Round((doubleNumber - beforeFloatingPoint)* 100)), ""));
